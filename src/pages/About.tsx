        ...
        <div className="homeGrid">
          ...
          <section className="homeLeft aboutMain">
            ...
            <section className="about-text">
              <div>
                Ich bin Webentwicklerin, die gerne Ordnung ins Chaos bringt –
                mit sauberem Code, einzigartigem Design und innovativen Lösungen
                für eine langfristige Architektur.
              </div>

              <div>
                Kreativität war schon immer ein fester Bestandteil meines Lebens
                – sie zieht sich durch mein gesamtes Leben und durch meine
                gesamte Familie. Auch mein Kind wurde davon nicht verschont.
                <svg
                  className="smiley"
                  viewBox="0 0 100 100"
              ...
              <div>
                ...
                ich zunächst den klassischen Schritt einer Ausbildung gegangen
                und habe Industriekauffrau gelernt.
              </div>
              ...
              <div>
                ...
                Zusätzlich war ich für die Shopgestaltung zuständig – zwar nur
                mit einem Baukastensystem, aber genau hier entstand die
                Verbindung aus technischem Prozessverständnis und Freude an
                Webgestaltung.
              </div>
              ...
              <div>
                Es folgte noch ein letzter Arbeitgeber: ein großer
                internationaler Industriekonzern. Als
                Custom-Order-Processing-Mitarbeiterin war ich im nationalen als
                auch internationalen Umfeld tätig. Die Rahmenbedingungen
                stimmten – gute Bezahlung, nette Kolleg:innen – und dennoch
                blieb dieser Wunsch, kreativ arbeiten zu wollen und meine
              ...
              <div>
                Mein Resümee: Es ist nie zu spät, seine Träume zu leben – und
              ...
              <div>
                ...
                Anforderungen zu durchdringen, Lösungen strukturiert zu
                entwickeln und Herausforderungen pragmatisch umzusetzen.
              </div>
              ...
              <div>
                Neben Code habe ich ein Herz für UI & UX. Ich mag Interfaces,
                die intuitiv sind, gut aussehen und nicht erst erklärt werden
                müssen. Wenn sich etwas logisch anfühlt und Spaß macht, bin ich
                zufrieden.
              </div>

              <div>
                Was mich antreibt? Gute und kreative Ideen, saubere Lösungen und
                der Moment, wenn aus ein paar Zeilen Code ein echtes Produkt
                wird.
              </div>

              <div>
                <strong>Kurz gesagt:</strong> Ich baue Websites, Webapps, Apps
                und Landingpages mit Anspruch, Persönlichkeit – und einer
